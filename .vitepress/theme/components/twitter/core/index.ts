...
let addScriptPromise: Promise<any>

/** Adds proviced script to the page, once **/
function addPlatformScript(src: string) {
  if (!addScriptPromise) {
    ...
    // console.warn(typeof addScriptPromise)
    // console.warn(addScriptPromise)
  }
...
const twitterEmbedComponent = (me: any) => {
  return {
    data() {
      return {
        isLoaded: false,
...
export { addPlatformScript, twitterEmbedComponent }
